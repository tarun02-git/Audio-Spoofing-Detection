...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='database/ASVspoof2019_LA_cm_protocols/',
    ...
    # Dataloader
    dev_set = data_utils_LA.ASVDataset(database_path=args.database_path, protocols_path=args.protocols_path,
                                       is_train=False, is_logical=is_logical,
    ...
    # Dataloader
    train_set = data_utils_LA.ASVDataset(database_path=args.database_path, protocols_path=args.protocols_path,
                                         is_train=True, is_logical=is_logical, transform=transforms,
